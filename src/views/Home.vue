            ...
            <div class="container">
                ...
                <div class="row mt-5 gap-5">
                    <div class="col d-flex justify-content-center">
                        <div class="card" >
                            <img loading="lazy" src="@/assets/images-optimized/service-1.webp" class="card-img-top" alt="services 1">
                    ...
                    <div class="col d-flex justify-content-center">
                        <div class="card">
                            <img loading="lazy" src="@/assets/images-optimized/service-2.webp" class="card-img-top" alt="services 1">
                            <div class="card-body px-5 py-4 d-flex flex-column justify-content-between">
